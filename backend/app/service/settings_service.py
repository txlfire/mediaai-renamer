...
SETTING_DEFINITIONS: dict[str, SettingDefinition] = {
    ...
    "operation_logs.max_total_mb": SettingDefinition(
        key="operation_logs.max_total_mb",
        category="operations",
        default=128,
        value_type="int",
        description="Operation log total storage limit in MB",
        min_value=1,
        max_value=4096,
    ),
    "operation_logs.max_task_mb": SettingDefinition(
        key="operation_logs.max_task_mb",
        category="operations",
        default=16,
        value_type="int",
        description="Operation log per-task storage limit in MB",
        min_value=1,
        max_value=1024,
    ),
    "operation_logs.cleanup_batch_size": SettingDefinition(
        key="operation_logs.cleanup_batch_size",
        category="operations",
        default=1000,
        value_type="int",
        description="Operation log cleanup batch size",
        min_value=100,
        max_value=10000,
    ),
